@{
    ...
    FunctionsToExport = @('Get-SitecoreRandomString','ConvertTo-CompressedBase64String','Get-SitecoreCertificateAsBase64String','Set-EnvironmentFileVariable','Set-SitecoreLicenseEnvironmentVariable','Set-SitecoreLicenseEnvironmentFile')
