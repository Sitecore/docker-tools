@{
    ...
    FunctionsToExport = @('Get-SitecoreRandomString','ConvertTo-CompressedBase64String','Get-SitecoreCertificateAsBase64String','Set-DockerComposeEnvFileVariable','Set-SitecoreLicenseEnvironmentVariable','Set-SitecoreLicenseEnvironmentFile')
