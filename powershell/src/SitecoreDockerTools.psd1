@{
    ...
    FunctionsToExport = @('Get-SitecoreRandomString','ConvertTo-CompressedBase64String','Set-EnvironmentFileVariable','Set-SitecoreLicenseEnvironmentVariable','Set-SitecoreLicenseEnvironmentFile')
